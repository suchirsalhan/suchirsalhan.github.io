...
A GitHub Pages (Jekyll) template for my personal academic website, based on a template available [here](https://luost.me/academic-homepage/) with additional modifications. 
